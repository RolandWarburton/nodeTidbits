...
module.exports = async (req, res, next) => {
	...
	if (token) {
		...
		console.log(`verified the received token with _id: "${decoded._id}"`);
		...
		const tokenVerifUrl = process.env.TOKENVERIFURL;
		...
		console.log("retrieving end user session key");
		...
		console.log("setting the user in the browser session");
		...
		console.log("reduirecting back to the client");
